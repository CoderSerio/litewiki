...
import { runDeepWikiAgent as runWithGoogleGemini } from "./googleGemini.js";
...
export async function runDeepWikiAgent(
  ...
  if (provider === "google") {
    return await runWithGoogleGemini(
      cwd,
      opts as unknown as Parameters<typeof runWithGoogleGemini>[1],
    );
  }
